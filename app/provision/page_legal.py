...
default_locator = 'legal'
default_template = 'provision-orders'

_PAGE_LINK = ('%slegal', '?sidebar=0',)
...
class PageLegal(PageDefault):

    def __init__(self, id, name, title, caption, **kw):
        if IsDeepDebug:
            print('PageLegal init')
    ...
    def is_page_manager(self):
        return (self.is_owner or self.is_legal_manager) and True or False
    @property
    def page_link(self):
        return _PAGE_LINK
    @property
    ...
    def system_config_emails_approval(self):
        return g.system_config.DEFAULT_EMAILS_LEGAL_APPROVAL or []
    @property
    def system_config_emails_create(self):
        return g.system_config.DEFAULT_EMAILS_LEGAL_CREATE or []
    @property
    def system_config_emails_remove(self):
        return g.system_config.DEFAULT_EMAILS_LEGAL_REMOVE or []
    @property
    def system_config_emails_review(self):
        return g.system_config.DEFAULT_EMAILS_LEGAL_REVIEW or []
    @property
    def system_config_emails_execute(self):
        return g.system_config.DEFAULT_EMAILS_LEGAL_EXECUTE or []
    @property
    def system_config_emails_payments(self):
        return g.system_config.DEFAULT_EMAILS_LEGAL_PAYMENTS or []
    @property
    def system_config_emails_audit(self):
        return g.system_config.DEFAULT_EMAILS_LEGAL_AUDIT or []
    @property
    def system_config_emails_decree(self):
        return g.system_config.DEFAULT_EMAILS_LEGAL_DECREE or []
    @property
    def system_config_emails_upload(self):
        return g.system_config.DEFAULT_EMAILS_LEGAL_UPLOAD or []
    ...
    def render(self, kw, back_where=None, uncheck_status=None):
        ...
        self.point('legal.render-finish')
