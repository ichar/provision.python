...
var $ReviewerDialog = {
    ...
    refresh: function(data) {
        ...
        content += 
              ...
              '<div class="profile">'+
                '<table border="0">'+
                  '<tr><td class="reviewer-caption">Подразделение:</td><td class="reviewer-value">'+data['subdivision']+'</td></tr>'+
                  '<tr><td class="reviewer-caption">Должность:</td><td class="reviewer-value">'+data['post']+'</td></tr>'+
                  '<tr><td class="reviewer-caption">Функциональная роль:</td><td class="reviewer-value">'+data['app_role_name']+'</td></tr>'+
                  '<tr><td class="reviewer-caption">Роль:</td><td class="reviewer-value">'+data['role_name']+'</td></tr>'+
                  '<tr><td class="reviewer-caption">Полномочия:</td><td class="reviewer-value">'+data['privileges']+'</td></tr>'+
                  '<tr><td class="reviewer-caption">Логин:</td><td class="reviewer-value">'+data['login']+'</td></tr>'+
                '</table>'+
              '</div>'+
            '</div>'+
            '<div class="reviewer-data"> '+
              '<div class="data">'+
                '<table border="0">'+
                '<tr>'+
                  '<td class="reviewer-order">Всего '+data['ob_types']+': '+data['orders']+'</td>'+
                  '<td class="reviewer-decree">Поручений выдано: '+data['decrees_out']+'</td>'+
                  '<td class="reviewer-decree">Поручений получено: '+data['decrees_in']+'</td>'+
                '</tr>'+
                '</table>'+
              '</div>'+
            '</div>';
